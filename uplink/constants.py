...
:func:`uplink.utils.reset_pulp`), this is the set of services that should
be restarted.
"""
...
"""The name of an RPM file. See :data:`uplink.constants.RPM_SIGNED_URL`."""

RPM2 = 'camel-0.1-1.noarch.rpm'
"""The name of an RPM. See :data:`uplink.constants.RPM2_UNSIGNED_URL`."""
...
:data:`uplink.constants.RPM_ERRATUM_RPM_NAME` and the erratum is present on
repository which feed is :data:`uplink.constants.RPM_SIGNED_FEED_URL`.
"""

RPM_ERRATUM_RPM_NAME = 'gorilla'
"""The name of the RPM named by :data:`uplink.constants.RPM_ERRATUM_ID`."""
...
"""An SRPM file at :data:`uplink.constants.SRPM_SIGNED_FEED_URL`."""
